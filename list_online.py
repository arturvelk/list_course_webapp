            ...
            with st.form ("tax_evasion", clear_on_submit=True):
                ...
                if submitted:
                    ...
                    with ph_3.container():
                        ...
                        row = [st.session_state["name"], st.session_state["strike_value"],st.session_state["stolen_money"], st.session_state["got_home"], st.session_state["final"], st.session_state["amount"], st.session_state["tax_value"]]
                        sh.append_row(row)
                        st.write("")
