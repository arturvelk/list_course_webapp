...
task_solution = ["3","9","16","20","26","43","36","37","42","54","68","83","82","108","110","117","115", "104","109","111","101","120","118","105","107","114","126","112","123","106","127","121","110","112","113","113","116","124","115","116","120","112","113","110","91","117","110","115","114","106","104","111","124","120","117","104","110","116","122","103"]
...
value = st.session_state["tax_prob"]
            ...
            with st.form ("tax_evasion", clear_on_submit=True):
                ...
                if submitted:
                    ...
                    with ph_3.container():
                        ...
                        row = [st.session_state["name"], st.session_state["strike"],st.session_state["stolen_money"], st.session_state["got_home"], st.session_state["final"], st.session_state["amount"], value]
                        sh.append_row(row)
                        st.write("")
